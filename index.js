...
// ============== Your answer here:
let newNumber = numbers.map((i) => 2 * i);
...
// ============== Your answer here:
let newNames = names.map((i) => i.toUpperCase());
...
// ============== Your answer here:
let newNumber2 = numbers2.map((i) => i * i);
...
// ============== Your answer here:
let newNames2 = names2.map((i) => i + " Smith");
...
// ============== Your answer here:
let newNumbers3 = numbers3.map((i) => i / 2);
...
// ============== Your answer here:
let newFruits = fruits.map((i) => i.charAt(0).toUpperCase() + i.slice(1));
